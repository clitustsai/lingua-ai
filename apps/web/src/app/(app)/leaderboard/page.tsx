...
const MOCK_USERS = [
  { rank: 1, name: "Nguyễn Minh Tuấn", avatar: "🦁", xp: 4820, streak: 32, level: "B2", badge: "👑" },
  { rank: 2, name: "Trần Thị Lan Anh", avatar: "🦋", xp: 3950, streak: 21, level: "B1", badge: "🥈" },
  { rank: 3, name: "Lê Văn Hùng", avatar: "🐯", xp: 3210, streak: 18, level: "B1", badge: "🥉" },
  { rank: 4, name: "Phạm Thu Hà", avatar: "🦊", xp: 2780, streak: 14, level: "A2", badge: "" },
  { rank: 5, name: "Võ Đức Thành", avatar: "🐺", xp: 2340, streak: 11, level: "A2", badge: "" },
  { rank: 6, name: "Hoàng Thị Mai", avatar: "🦄", xp: 1980, streak: 9, level: "A1", badge: "" },
  { rank: 7, name: "Bùi Quang Huy", avatar: "🐸", xp: 1650, streak: 7, level: "A1", badge: "" },
  { rank: 8, name: "Đặng Thị Ngọc", avatar: "🌸", xp: 1320, streak: 5, level: "A1", badge: "" },
];
...
export default function LeaderboardPage() {
  ...
  const myEntry = { rank: 0, name: user?.name || "Bạn", avatar: user?.avatar || "⭐", xp: myXp, streak, level: "A1", badge: "", isMe: true };
