...
const NAV_GROUPS = (tr: any) => [
  {
    ...
    items: [
      ...
      { href: "/generate-lesson", icon: Zap,           label: "Tạo bài học AI" },
      { href: "/solve",         icon: CheckSquare,     label: tr.solveExercise },
    ],
  },
  {
    label: "Luyện tập",
    items: [
      ...
      { href: "/grammar",       icon: Languages,       label: tr.grammar },
      { href: "/translate",     icon: Globe,           label: tr.translate },
    ],
  },
  {
    label: "Nội dung",
    items: [
      ...
      { href: "/learning-path", icon: TrendingUp,      label: tr.learningPath },
    ],
  },
  {
    label: "Công cụ AI",
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/exam",          icon: Award,           label: "Thi chứng chỉ" },
      { href: "/certificate",   icon: Star,            label: "Chứng chỉ" },
      ...
      { href: "/community",     icon: MessageCircle,   label: tr.community },
    ],
  },
  {
    label: "Khác",
    items: [
      ...
      { href: "/study-sets",    icon: BookMarked,      label: tr.studySets },
