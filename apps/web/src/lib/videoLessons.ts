...
export const VIDEO_LESSONS: VideoLesson[] = [
  // ── GRAMMAR ──────────────────────────────────────────────────────────────
  { id: "v1", youtubeId: "LIfIFAMnJA0", title: "Present Simple vs Present Continuous", teacher: "Emma", country: "Canada", flag: "🇨🇦", topic: "Present tenses comparison with examples", category: "grammar", level: "A2-B1", durationSec: 480, tags: ["tenses", "present", "grammar"] },
  { id: "v2", youtubeId: "Yt5pBMFBMkA", title: "Past Tense: Regular & Irregular Verbs", teacher: "Alex", country: "UK", flag: "🇬🇧", topic: "How to use past simple tense correctly", category: "grammar", level: "A1-A2", durationSec: 360, tags: ["past tense", "verbs", "grammar"] },
  { id: "v3", youtubeId: "WlM_8bFMoAg", title: "Conditionals: If Clauses Explained", teacher: "Ronnie", country: "Canada", flag: "🇨🇦", topic: "First, second and third conditionals", category: "grammar", level: "B1-B2", durationSec: 540, tags: ["conditionals", "if clauses", "grammar"] },
  ...
  { id: "v6", youtubeId: "sIFYPQjYhv8", title: "Passive Voice Made Easy", teacher: "Ronnie", country: "Canada", flag: "🇨🇦", topic: "Active vs passive voice with examples", category: "grammar", level: "B1-B2", durationSec: 450, tags: ["passive voice", "grammar", "intermediate"] },
  ...
  { id: "v11", youtubeId: "1Evwgu369Jw", title: "Job Interview English", teacher: "Alex", country: "UK", flag: "🇬🇧", topic: "Common interview questions and answers", category: "conversation", level: "B1-B2", durationSec: 600, tags: ["interview", "business", "professional"] },
  ...
  { id: "v14", youtubeId: "OGMxMSMJMhA", title: "Making Plans & Suggestions", teacher: "James", country: "UK", flag: "🇬🇧", topic: "Phrases for making plans with friends", category: "conversation", level: "A2-B1", durationSec: 360, tags: ["plans", "suggestions", "phrases"] },
  ...
  // ── VOCABULARY ───────────────────────────────────────────────────────────
  { id: "v16", youtubeId: "F4dFNFBMkA0", title: "100 Common English Phrases", teacher: "Rachel", country: "USA", flag: "🇺🇸", topic: "Most useful everyday English phrases", category: "vocabulary", level: "A1-B1", durationSec: 720, tags: ["phrases", "vocabulary", "everyday"] },
  ...
  { id: "v20", youtubeId: "Yt5pBMFBMkA", title: "Collocations: Words That Go Together", teacher: "Alex", country: "UK", flag: "🇬🇧", topic: "Natural word combinations in English", category: "vocabulary", level: "B1-B2", durationSec: 480, tags: ["collocations", "natural English", "vocabulary"] },
  ...
  { id: "v25", youtubeId: "sIFYPQjYhv8", title: "Word Stress & Intonation", teacher: "Ronnie", country: "Canada", flag: "🇨🇦", topic: "How stress changes meaning in English", category: "pronunciation", level: "B1-B2", durationSec: 420, tags: ["stress", "intonation", "pronunciation"] },
  ...
  { id: "v28", youtubeId: "HnJp9T3Gx_4", title: "News English: Understanding Headlines", teacher: "Alex", country: "UK", flag: "🇬🇧", topic: "How to understand English news", category: "listening", level: "B2-C1", durationSec: 600, tags: ["news", "headlines", "advanced"] },
  ...
  { id: "v30", youtubeId: "F4dFNFBMkA0", title: "Doctor's Appointment Dialogue", teacher: "Ronnie", country: "Canada", flag: "🇨🇦", topic: "Medical English conversations", category: "listening", level: "B1", durationSec: 360, tags: ["medical", "health", "dialogue"] },
  { id: "v31", youtubeId: "Xnt-QSgBHaM", title: "6 Minute English: Technology", teacher: "BBC", country: "UK", flag: "🇬🇧", topic: "Discussing technology in English", category: "listening", level: "B1-B2", durationSec: 360, tags: ["technology", "BBC", "listening"] },
